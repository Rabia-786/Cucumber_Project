...
public class TestSuite extends BaseTest{
    ...
    public void userExploreTestData(){
        ...
        @Test
        public void userShouldBeAbleToAddCommentsSucessfully() {
            comments.addCommentsToPage();
            Assert.assertEquals(comments.getResultText(), "News comment is successfully added.");
        }
         @Test
          public void userShouldBeAbleToBuyItemSuccessfully(){
